...
function SignUpSuccessScreen(props: {}) {
  ...
  return (
    <Stack
      direction='row'
      spacing='94px'
      css={{ alignItems: 'center', justifyContent: 'center', height: '100%', position: 'relative' }}
    >
      <YellowStar
      ...
      <Stack direction='column' spacing='40px'>
        ...
        <Typography variant='body1' css={(theme: Theme) => ({ fontWeight: 500, color: theme.palette.secondary.n300 })}>
          링크게더 가입이 완료되었습니다!
          <br />
